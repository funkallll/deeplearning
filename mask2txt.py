...
def mask_to_yolo(mask_dir, save_dir, num_label, num_points, validation=False):
    ...
    for img in imgs:
        ...
        img_current = cv2.imread(img_path, cv2.IMREAD_GRAYSCALE)
...
if __name__ == '__main__':
    ...
    # mask_to_yolo(r"F:\x\20240425\all_data\segment\odata\Rotate_png_data\png_r", r"F:\x\20240425\all_data\segment\odata\Rotate_png_data\png_r_labels", 1, 64, False)
    mask_to_yolo(r"E:\deeplearning\data\prac\seg\data\rotate\labels_mask",
                 r"E:\deeplearning\data\prac\seg\data\rotate\labels_txt_3", 1, 256, False)
